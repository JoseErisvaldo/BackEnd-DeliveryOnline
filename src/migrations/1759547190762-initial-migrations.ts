...
export class InitialMigrations1759547190762 implements MigrationInterface {
    name = 'InitialMigrations1759547190762'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categorys" ("category_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "PK_9294b399fc72c74c5bf1114f470" PRIMARY KEY ("category_id"))`);
        await queryRunner.query(`CREATE TABLE "ingredients" ("ingredient_id" BIGSERIAL NOT NULL, "price" double precision, "description" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "product_id" bigint, "user_id" uuid, CONSTRAINT "PK_ca1733bfdc5be587ed299844ac1" PRIMARY KEY ("ingredient_id"))`);
